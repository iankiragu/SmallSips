...
class Network {
  final String _url = 'https://tribore.azurewebsites.net/public/api/';
...
//    }
  ...
  Future<List> getGoogleHospitals() async {
    const googleHospitalsURL =
        'https://tribore.azurewebsites.net/public/api/get_hospitals';
  ...
  Future<List> getDoctors() async {
    const getDoctorsURL =
        'https://tribore.azurewebsites.net/public/api/get_doctors_json';
    // Retrieve the locations of Google offices
  ...
  Future<List> getAppointments(data) async {
    ...
    const getappointment =
        'https://tribore.azurewebsites.net/public/api/get_appointments';
    // Retrieve the locations of Google offices
